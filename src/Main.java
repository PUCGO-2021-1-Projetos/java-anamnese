...
public class Main {
    ...
    protected static final String[] DOENCAS = {"Corona Virus (Covid-19)", "H1N1 (Influenza)", "Pneumonia",};

    protected static final String[] DOENCAS_CHAVES = {"COVID19", "H1N1", "PNEUMONIA",};
     ...
     */
    protected static final Integer[] H1N1_SINTOMAS = {0, // calafrios
        1, // cansaço e fadiga
        3, // Coriza
        4, // Descoloração dos dedos das mãos ou dos pés
        5, // diarreia
     ...
     */
    protected static final Integer[] COVID19_SINTOMAS = {1, // cansaço e fadiga
        2, // conjuntivite
        4, // Descoloração dos dedos das mãos ou dos pés
        5, // diarreia
        6, // dificuldade de respirar
     ...
     */
    protected static final Integer[] PNEUMONIA_SINTOMAS = {4, // Descoloração dos dedos das mãos ou dos pés
        6, // dificuldade de respirar
        7, // dor de cabeça
        9, // dor no peito
        10, // dores musculares
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println();
        System.out.println("Aqui você poderá obter, de forma ágil, um possível pré-diagnóstico sobre suas queixas.");
        System.out.println();
     ...
     * usuário
     * @return boolean - TRUE se o menu principal continua ativo. FALSE para
     * encerrar
     */
    ...
    /**
     * Listar Doenças. Este método é responsável por listar as doenças
    ...
    /**
     * Listar Sintomas de uma doença Este método é responsável pelo menu de
     * listar os sintomas das doenças
     *
     * @param Scanner scanner - Objeto que possui suporte de resgatar entrada do
     * usuário
     */
    private static void listarSintomas(Scanner scanner) throws IOException {
        System.out.println();
        System.out.println("Vamos listar os possíveis sintomas reconhecidos. Para isso, selecione uma doença:");
        ...
        do {
            ...
            for (int i = 0; i < Main.DOENCAS.length; i++) {
                System.out.println((i + 1) + ") " + Main.DOENCAS[i]);
            }
            System.out.println("--");
            ...
            System.out.println("--");
            System.out.println("");
            System.out.print("Escolha uma doença para para listar os sitomas: ");
    ...
    /**
     * Este método lista no console os sintomas informados através do indice das
     * doenças da lista.
     *
    ...
    private static void realizarAnamnese(Scanner scanner) throws IOException {
        ...
        // Este trecho exibe na tela os listaSintomas e ao final captura e valida input
        // do usuário
        System.out.println();
        ...
        do {
            System.out.println("--");
            System.out.print("Informe o sintoma ou (\"D\": diagnosticar, \"V\": Voltar, \"R\": recomeçar): ");
            input = scanner.nextLine().toUpperCase();
        ...
        if (input.equals("D")) {
            ...
            System.out.println(
                    "- " + Main.COVID19 + ": " + mostraProbabilidadeDoanca(Main.COVID19_SINTOMAS, listaSintomas));
            System.out.println("- " + Main.H1N1 + ": " + mostraProbabilidadeDoanca(Main.H1N1_SINTOMAS, listaSintomas));
            System.out.println(
                    "- " + Main.PNEUMONIA + ": " + mostraProbabilidadeDoanca(Main.PNEUMONIA_SINTOMAS, listaSintomas));
     ...
     * @return String INCERTO, IMPROVÁVEL, POUCO PROVÁVEL, PROVAVEL, MUITO
     * PROVAVEL
     */
